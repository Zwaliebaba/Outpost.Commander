...
public:
  TEST_METHOD(AValidOrderIsApplied)
  {
    ...
    const Outpost::EntityId mine = world.Create(Neuron::Vec2{}, 0, 1, MINE);
  ...
  TEST_METHOD(AForeignEntityIsRejected)
  {
    ...
    Outpost::World world;
    Outpost::CommandIntake intake;
    static_cast<void>(world.Create(Neuron::Vec2{}, 0, 1, MINE));
    const Outpost::EntityId theirs = world.Create(Neuron::Vec2{}, 0, 1, THEIRS);
  ...
  TEST_METHOD(AStaleGenerationIsRejected)
  {
    ...
    Outpost::World world;
    Outpost::CommandIntake intake;
    const Outpost::EntityId dead = world.Create(Neuron::Vec2{}, 0, 1, MINE);
    const std::uint16_t staleWire = Wire(dead);
    Assert::IsTrue(world.Destroy(dead));

    const Outpost::EntityId reborn = world.Create(Neuron::Vec2{}, 0, 1, MINE);
  ...
  TEST_METHOD(AHalfValidSelectionAppliesNoneOfIt)
  {
    ...
    Outpost::CommandIntake intake;
    const Outpost::EntityId mine = world.Create(Neuron::Vec2{}, 0, 1, MINE);
    const Outpost::EntityId alsoMine = world.Create(Neuron::Vec2{}, 0, 1, MINE);
    static_cast<void>(world.Create(Neuron::Vec2{}, 0, 1, MINE));
    const Outpost::EntityId theirs = world.Create(Neuron::Vec2{}, 0, 1, THEIRS);
