...
// 14 instanced draws per frame covers every owner at every player count.
#pragma once
#include <cstdint>
#include <array>
...
inline constexpr std::array<MeshAsset, 14> kMeshAssets = {{
    ...
    { L"Cruiser", L"ms-appx:///Assets/Meshes/Cruiser.cmo", 316, 948,
      { -32.00f, -14.00f, -90.00f }, { 32.00f, 21.00f, 90.00f } },
    ...
    { L"Station", L"ms-appx:///Assets/Meshes/Station.cmo", 1032, 3096,
      { -110.00f, -26.00f, -110.00f }, { 110.00f, 60.00f, 110.00f } },
