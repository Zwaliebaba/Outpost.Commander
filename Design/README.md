...
| [`Interface.md`](Interface.md) | What the operator sees and clicks in M1: the frame at the authored resolution, the chrome and its palette, the pointer and the hotkeys, selection and orders, the five command tabs, the selection panel, the minimap and the readouts, the overlays | Design — **§4, §6, §7 and §12 ruling 3 superseded** by [`ADR-021`](ADR/ADR-021-touch-is-the-only-input.md) on 2026-09-20; `t1-touch-interface/T1` rewrites them |
