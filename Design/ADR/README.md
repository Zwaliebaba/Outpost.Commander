...
| [`ADR-002`](ADR-002-tick-and-numbers.md) | The 20 Hz tick, the 1/256 position unit, the 16-bit binary angle over a 4,096-entry sine table, the pinned PRNG, and candidate ordering as a correctness property | Proposed | 2026-09-20 |
| [`ADR-003`](ADR-003-replication-is-full-snapshots.md) | Full self-contained snapshots at 10 Hz, no delta and no acknowledgement; commands made reliable by a sequence the snapshot already carries | Proposed | 2026-09-20 |
| [`ADR-004`](ADR-004-weapons-resolve-at-the-fire-tick.md) | No projectile entities in the MVP: damage lands on the tick a weapon fires and the client draws an event | Proposed | 2026-09-20 |
| [`ADR-005`](ADR-005-meshes-are-generated-in-code.md) | No mesh format, no loader and no asset build step in the MVP | Proposed | 2026-09-20 |
...
ruled; a proposed ADR is not something to write code against.
