...
| **ADR-022** | A bot is a headless client, and one process runs many of them to load the host | M1.14b, **Proposed 2026-09-23** |
| **ADR-023** | Ownership is a group in the snapshot, and the host's player count is configurable past four for stress runs | M1.14c, **Proposed 2026-09-23** |
