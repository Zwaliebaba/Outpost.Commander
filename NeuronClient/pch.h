...
// The precompiled header of NeuronClient: the standard library, then the platform in the order
// AGENTS.md §4 fixes -- NeuronCore's WindowsHeader.h, the one owner of the Windows macro family, before
...
// (ADR-004). Every translation unit of NeuronClient draws or sits beside one that does, so the platform
// is precompiled once here. A header of NeuronClient still includes what it names, because the
